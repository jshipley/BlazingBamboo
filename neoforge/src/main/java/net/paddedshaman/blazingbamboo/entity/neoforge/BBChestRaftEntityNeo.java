...
public class BBChestRaftEntityNeo extends BBChestRaftEntity {

    public BBChestRaftEntityNeo(EntityType<? extends BBChestRaftEntity> entityType, Level level, Supplier<Item> supplier) {
        super(entityType, level, supplier);
    }

    public BBChestRaftEntityNeo(EntityType<? extends BBChestRaftEntity> entityType, Level level) {
